            ...
            if ( actions.length ) {
                ...
                for ( var i=0; i<actions.length; i++ ) {
                    ...
                    if ( 'function' != typeof callback ) {
                        ...
                        href = 'javascript:;" onclick="jQuery.mnTextSelector.tempMethod('+ i + ')';
                    }
            ...
            if (sel) {
                if (sel.type != "Control") {
                    ...
                    if ( document.addEventListener ) { // IE 9+
                        xOffset = $(window).scrollLeft();
                        yOffset = $(window).scrollTop();
                    } else {
                        xOffset = ( document.documentElement &&
                                    document.documentElement.scrollLeft ) ||
                                    document.body.scrollLeft;
                        yOffset = ( document.documentElement && 
                                    document.documentElement.scrollTop ) || 
                                    document.body.scrollTop;
                    }
                    x = range.boundingLeft + xOffset;
                    y = range.boundingTop + yOffset;
                }
